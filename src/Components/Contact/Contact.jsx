...
const Contact = () => {
  ...
  return (
    <>
    <div className='bg-ContactBg bg-cover bg-fixed py-10 lg:py-20 relative after:absolute after:top-0 after:left-0  after:bg-black after:w-full after:h-full  after:opacity-50'>
    <Container>
