...
const Heading = ({Headerp1,Headerp2,className}) => {
  return (
    <div>
        <h1 className='relative z-[1] text-2xl lg:text-6xl font-IBM font-bold text-center py-8 lg:py-14 text-white'>{Headerp1}<span className='text-primary'> {Headerp2}</span>
