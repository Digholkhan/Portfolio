...
<footer class="bg-black relative">
    ...
    <div class="grid  px-4 py-6 lg:py-8 md:grid-cols-4">
        ...
        <div className='col-span-2 md:col-span-1  md:pl-20 md:text-justify text-center  pt-5 md:pt-0'>
            ...
            <h2 class="mb-2 md:mb-6 text-sm font-bold text-gray-900 uppercase dark:text-primary">Contact</h2>
                ...
                <li class="mb-4">
                    <a href="#" class="hover:underline">Digholkhan@gmail.com</a>
                </li>
                <li class="mb-4">
                    <a href="#" class="hover:underline">Mirpur Dhaka 1216</a>
               </li>
            </ul>
        </div>
    </div>
    ...
    <div class="px-4 py-6 bg-gray-700 text-center md:text-justify md:flex md:items-center md:justify-between">
        ...
        <div class="flex mt-4 space-x-5 justify-center md:mt-0">
              ...
              <a href="https://www.linkedin.com/in/dighol-khan-25675b245/"><AiFillLinkedin className='text-white text-xl hover:scale-110 hover:drop-shadow-[2px_04px_5px_rgba(0,149,180)] duration-200 ease-linear'/></a>
              <a href="https://wa.me/qr/5FEIT3T6EKBAA1"><IoLogoWhatsapp className='text-white text-xl hover:scale-110 hover:drop-shadow-[2px_04px_5px_rgba(0,149,180)] duration-200 ease-linear'/></a>
              <a href="https://www.facebook.com/Dighol.00imi"><BiLogoFacebookCircle className='text-white text-xl hover:scale-110  hover:drop-shadow-[2px_04px_5px_rgba(0,149,180)] duration-200 ease-linear'/></a>
              <a href="https://www.instagram.com/dighol_khan/"><AiFillInstagram className='text-white text-xl hover:scale-110 hover:drop-shadow-[2px_04px_5px_rgba(0,149,180)] duration-200 ease-linear'/></a>
        </div>
      </div>
    </div>
</footer>
